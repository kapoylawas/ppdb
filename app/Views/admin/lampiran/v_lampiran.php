...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Tabel Master Lampiran</h3>
        ...
        <tbody>
          <?php $no=1; foreach ($lampiran as $key => $value) { ?>
              <tr>
               ...
               <td>
                    <button class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#delete<?= $value['id_lampiran'] ?>"><i class="fas fa-trash"></i></button>
                    <button class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#edit<?= $value['id_lampiran'] ?>"><i class="fas fa-edit"></i></button>
               </td>
              </tr>
          <?php } ?> 
        </tbody>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="form-group">
                    <label>lampiran</label>
                    <input type="text" name="lampiran" value="<?= $value['lampiran'] ?>" class="form-control" placeholder="lampiran" required>
                 </div>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="delete<?= $value['id_lampiran'] ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
               Apakah Anda Ingin Menghapus Data <b class="btn btn-danger btn-sm"><?= $value['lampiran'] ?></b>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
